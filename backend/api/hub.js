...
router.post("/tour/booking", sessionware, adminware, bookings.createBooking);
router.post("/tourbook", sessionware, adminware, bookings.logTourBooking);
router.post("/tourbook/addvoucher", sessionware, adminware, bookings.createBookingVoucher);
...
//Update
router.put("/profile/:id", sessionware, adminware, profiles.updateProfile);
