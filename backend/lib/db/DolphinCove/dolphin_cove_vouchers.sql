...
CREATE TABLE `vouchers` (
  ...
  PRIMARY KEY (`voucher`,`date`,`tour_co_id`),
  KEY `tour_company_id_idx` (`tour_co_id`),
  ...
  CONSTRAINT `tour_company_id` FOREIGN KEY (`tour_co_id`) REFERENCES `tour_companies` (`tour_co_id`)
